...
http.createServer(function (req, res) {
  ...
  res.write('.button { background-color: #28a745; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin-right: 10px; }');
  res.write('.button-secondary { background-color: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin-right: 10px; }');
  res.write('</style>');
  res.write('</head>');
  res.write('<body>');
  ...
  res.write('<input type="text" placeholder="Enter your email">');
  res.write('</div>');
